...
<ol><li>Download and install [QD](http://crd-legacy.lbl.gov/~dhbailey/mpdist/) so that your compiler can resolve the necessary includes, e.g., `#include <qd/` (FIX THIS)</li><li>When compiling Algoim-related code, use your compiler to define a global-scope preprocessor directive for `ALGOIM_HPREAL` as follows:<ul><li>To use double-double precision, define...</li><li>To use quadruple-double precision, define...</li>For example...</li></ol>
