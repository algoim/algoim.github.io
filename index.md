...
| Assumes the domain is constrained by a user-defined hyperrectangle (triangular constraint cells can be used in 2D, but 3D simplices require care) | Can be used on hyperrectangular and simplex constraint cells; in fact, any compact semi-algebraic set constraint domain is possible |
