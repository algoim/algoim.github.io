...
- `algoim/src/algoim_stencilpoly_detail.hpp`: This file contains the precomputed pseudoinverses of the polynomial interpolation matrices and the various stencils for use with rectangular Cartesian grids, as described in the paper.
